...
fig.tight_layout()
fig.savefig('/home/wei-chi/Alzheimers_Project/external_data/scripts/results/E1_to_E10_auc_trend.png', dpi=150, bbox_inches='tight')
plt.close(fig)
...
ax.grid(axis='y', alpha=0.3)
fig.tight_layout()
fig.savefig('/home/wei-chi/Alzheimers_Project/external_data/scripts/results/E1_to_E10_acc_trend.png', dpi=150, bbox_inches='tight')
plt.close(fig)
...
fig.tight_layout()
fig.savefig('/home/wei-chi/Alzheimers_Project/external_data/scripts/results/E1_to_E10_auc_bar.png', dpi=150, bbox_inches='tight')
plt.close(fig)
...
ax.axhline(0.7, color='gray', linestyle=':', alpha=0.5)
fig.tight_layout()
fig.savefig('/home/wei-chi/Alzheimers_Project/external_data/scripts/results/E1_to_E10_acc_bar.png', dpi=150, bbox_inches='tight')
plt.close(fig)
...
fig.tight_layout()
fig.savefig('/home/wei-chi/Alzheimers_Project/external_data/scripts/results/E1_to_E10_per_task.png', dpi=150, bbox_inches='tight')
plt.close(fig)
